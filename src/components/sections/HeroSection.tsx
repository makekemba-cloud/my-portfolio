      ...
      <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#000000] py-32">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          <div className="flex gap-8 items-center mb-16">
            ...
            {/* Right - Text Content (3/4 width, centered) */}
            <div className="flex-1 text-center">
              ...
              {/* Subheading */}
              <div className={`mb-8 transition-all duration-1000 delay-200 transform ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <p className="text-lg text-[#9CA3AF] leading-relaxed max-w-2xl mx-auto">
                  I build production-grade fullstack applications with a focus on security, performance, and user experience. Specializing in Next.js, React, Node.js, and Supabase.
                </p>
              </div>

              {/* CTA Buttons */}
              <div className={`flex flex-col sm:flex-row gap-5 justify-center mb-8 transition-all duration-1000 delay-300 transform ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <button
                  onClick={() => handleScrollToSection('projects')}
                  className="group relative px-8 py-4 bg-[#2563EB] text-white rounded-lg font-semibold flex items-center justify-center gap-2 overflow-hidden transition-all duration-300 hover:bg-[#1d4ed8] shadow-lg shadow-[#2563EB]/30 hover:shadow-[#2563EB]/50"
                >
                ...
                <button
                  ...
                  className="px-8 py-4 border-2 border-[#2563EB]/30 text-[#F9FAFB] rounded-lg font-semibold hover:border-[#2563EB] hover:bg-[#2563EB]/5 transition-all duration-300"
                >
                  Get in Touch
                </button>
              </div>
